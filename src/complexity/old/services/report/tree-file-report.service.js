...
exports.TreeFileReportService = void 0;
 ...
 */
class TreeFileReportService {
    constructor(treeFile) {
        ...
        this.treeFile = undefined; // The TreeFile relative to this service
    ...
    generateReport() {
        ...
        this.relativeRootReports = file_service_1.getRouteToRoot((_a = this.treeFile.treeFolder) === null || _a === void 0 ? void 0 : _a.relativePath);
        ...
        const reportTemplate = eol.auto(fs.readFileSync(`${options_1.Options.pathGeneseNodeJs}/src/complexity/old/templates/handlebars/file-report.handlebars`, 'utf-8'));
    ...
    writeReport() {
        ...
        const filenameWithoutExtension = file_service_1.getFilenameWithoutExtension(this.treeFile.name);
        const pathReport = `${options_1.Options.pathOutDir}/${(_a = this.treeFile.treeFolder) === null || _a === void 0 ? void 0 : _a.relativePath}/${filenameWithoutExtension}.html`;
    ...
    registerPartial(partialName, filename) {
        const partial = eol.auto(fs.readFileSync(`${options_1.Options.pathGeneseNodeJs}/src/complexity/old/templates/handlebars/${filename}.handlebars`, 'utf-8'));
        Handlebars.registerPartial(partialName, partial);
    }
}
exports.TreeFileReportService = TreeFileReportService;
