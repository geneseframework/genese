...
exports.TreeFolderReportService = void 0;
...
class TreeFolderReportService {
    ...
    generateReport() {
        ...
        const reportTemplate = eol.auto(fs.readFileSync(`${options_1.Options.pathGeneseNodeJs}/src/complexity/old/templates/handlebars/folder-report.handlebars`, 'utf-8'));
