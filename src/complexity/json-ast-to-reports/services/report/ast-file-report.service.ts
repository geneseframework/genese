...
export class AstFileReportService {
    ...
    generateReport(): void {
        ...
        const reportTemplate = eol.auto(fs.readFileSync(`${Options.pathGeneseNodeJs}/src/complexity/ast-to-reports/templates/handlebars/file-report.handlebars`, 'utf-8'));
