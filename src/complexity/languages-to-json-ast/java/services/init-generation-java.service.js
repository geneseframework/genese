...
exports.InitGenerationJavaService = void 0;
const fs = require("fs-extra");
const ast_file_generation_java_service_1 = require("./ast-file-generation-java.service");
 ...
 */
class InitGenerationJavaService {
    /**
    ...
    isFileToGenerate(path) {
        return (file_service_1.getFileExtension(path) === 'java' && !globals_const_1.LIMIT_GENERATIONS) || path === globals_const_1.DEV_MOCK;
    }
}
exports.InitGenerationJavaService = InitGenerationJavaService;
