...
export class TsNode {
    ...
    pos?: number = undefined;                       // The position of the beginning of the AST node, including spaces and comments before it. This field will be injected as is in the JsonAst file
    start?: number = undefined;                     // The position of the real beginning of the AST node, without spaces and comments before it. This field will be injected as is in the JsonAst file
