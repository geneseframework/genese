...
export class TreeFolder extends Evaluable implements HasStats {
    ...
    parent?: TreeFolder = undefined;                                            // The AstFolder corresponding to the parent folder of this AstFolder
    ...
    treeFolderService?: TreeFolderService = new TreeFolderService();            // The InitService linked to this AstFolder
