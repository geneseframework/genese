...
class TreeFolder extends evaluable_model_1.Evaluable {
    constructor() {
        ...
        this.treeFolderService = undefined; // The TreeFolderService linked to this TreeFolder
        this.treeFolderService = new tree_folder_service_1.TreeFolderService(this);
    }
    /**
